  ...
  return (
    user && (
      <div className="flex flex-col h-screen">
        <div className="flex items-center gap-2 p-2 md:px-10 xl:pl-42 bg-gradient-to-e from-indigo-50 to-purple-50 border-b border-gray-300">
          <img
        ...
        <div className="p-5 md:px-10 h-full overflow-y-scroll">
          <div className="space-y-4 max-y-4xl mx-auto">
            {messages
